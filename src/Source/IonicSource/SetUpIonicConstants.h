...
/*! \brief
  ...
  Ionic Model Class. Enought to Create it once and pass a pointer to
...
namespace voom {
  ...
  void SetUpMahajanParameters(Real **constants,  int pos) {
    ...
    // gtof [7]  and gks [10] depends on pos
    switch (pos) {
  
   
    case 2:           { Constants[7] = 0.11;  Constants[10] = 0.32;   break;}	
    case 1:           { Constants[7] = 0.11;  Constants[10] = 0.48;   break; } 
    case 0:           { Constants[7] = 0.11;  Constants[10] = 0.64;   break; }
    case 5:  { Constants[7] = 0.055; Constants[10] = 0.2176;  break; }
    case 4: { Constants[7] = 0.055; Constants[10] = 0.288;  break; }
    case 3: { Constants[7] = 0.055; Constants[10] = 0.384; break; }
    case 8: { Constants[7] = 0.055; Constants[10] = 0.256;  break; }
    case 7: { Constants[7] = 0.055; Constants[10] = 0.32;   break; }
    case 6: { Constants[7] = 0.055; Constants[10] = 0.432;  break; }
    default: 
      {
	std::cout << "Tissue Type not set correctly. Setting to Epi-Apex\n";
	Constants[7] = 0.11;  Constants[10] = 0.32; 
      }
    }
    Constants[8] = 0.84;  //gnaca
    Constants[9] = 0.0125; //0.27; // 0.01875; // 0.0125;//gkr
