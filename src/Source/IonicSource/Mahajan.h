//-*-C++-*-
#ifndef __Mahajan_h__
#define __Mahajan_h__

/*! \file ucla.c
 *  \brief Souce code for the UCLA rabbit ventricle model.
 *
...
namespace voom {
  class Mahajan: public IonicMaterial {
  private:
    //! Number of Variables
    int _nVar;
  ...
  public:
    ...
    Mahajan(Real *Constants, const int pos = 0);
