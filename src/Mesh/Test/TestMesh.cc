...
*/  
  {
    cout << endl << "Test FEmesh constructor for filament from nodes and conn table files " << endl;

    FEMesh TestFEmesh("Filament.node", "Filament.ele");
    cout << "Number Of Nodes   : " << TestFEmesh.getNumberOfNodes() << endl;
    cout << "Number Of Element : " << TestFEmesh.getNumberOfElements() << endl;
    cout << "Mesh Dimension    : " << TestFEmesh.getDimension() << endl;
    cout << endl << "Nodal position" << endl;
    ...
    cout << endl << "END of Test FEmesh constructor for filament from nodes and conn table files " << endl;
  }
